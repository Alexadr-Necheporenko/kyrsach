...
async def process_answer(query: CallbackQuery, callback_data: dict, state: FSMContext):
    ...
    await query.message.answer('Напиши відповідь.', reply_markup=ReplyKeyboardRemove())
...
async def process_submit(message: Message, state: FSMContext):
    ...
    await message.answer('Переконайтесь, що не помилились у відповіді.', reply_markup=submit_markup())
